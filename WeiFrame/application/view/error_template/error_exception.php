  ...
  <div id="main">
    ...
    <div id="content">
        <h2>
            ...
            <p class="message"><?php echo $exception->getMessage()?></p>
            <p class='title'>Filename: </p>
            <p class="message"><?php echo $exception->getFile(); ?></p>
            <p class="title">Error Line Number: <?php echo $exception->getLine(); ?></p>
        </h2>
    </div>
    </div>
  </div>
